...
{
	public abstract class ServerCompanyDAOBase : AbstractDAO<ServerCompanyInfo> 
	{
		/// <summary>
		...
		/// Constructor
		/// </summary>
        public ServerCompanyDAOBase(string ConnectionString) :
            base(DbConstants.DatabaseProviderType, DbConstants.DatabaseType, "ServerCompany", ConnectionString) 
        {
        ...
        protected override ServerCompanyInfo MapObject(System.Data.IDataReader r) 
        {
			...
			entity.ServerCompanyID = r.GetInt32Value("CompanyID");
            ...
            entity.DBUserID = r.GetStringValue("UserID");
            entity.DBPassword = r.GetStringValue("Password");
            entity.IsVersionAlreadyRun = r.GetBooleanValue("IsVersionAlreadyRun");   
            return entity;
        }
        ...
        protected override System.Data.IDbCommand CreateUpdateCommand(ServerCompanyInfo entity) 
        {
			...
			pkparServerCompanyID.ParameterName = "@CompanyID";
