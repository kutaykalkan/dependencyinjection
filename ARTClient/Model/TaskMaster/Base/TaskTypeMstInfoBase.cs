...
{    
	...
	[DataContract]
	[Serializable]
	public abstract class TaskTypeMstInfoBase
	{
		...
		protected System.String _TaskType = null;
		protected System.Int16? _TaskTypeID = null;
		protected System.Int32? _TaskTypeLabelID = null;
		[DataMember]
		...
		public virtual System.String TaskType 
		{
		...
		[DataMember]
		[XmlElement(ElementName = "TaskTypeLabelID")]
		public virtual System.Int32? TaskTypeLabelID 
		{
			get { return this._TaskTypeLabelID; }
			set { this._TaskTypeLabelID = value; }
		}			
