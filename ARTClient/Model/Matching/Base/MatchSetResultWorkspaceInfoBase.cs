...
{    
	...
	/// </summary>
	[Serializable]
	public abstract class MatchSetResultWorkspaceInfoBase
	{
				...
				protected System.String _AddedBy = null;
						...
						protected System.Int64? _MatchSetResulWorkspaceID = null;
						...
						protected System.String _WorkspaceMatchData = null;
						protected System.String _WorkspacePartialMatchData = null;
						protected System.String _WorkspaceUnmatchData = null;
		...
		[XmlElement(ElementName = "MatchSetResultWorkspaceID")]
				public virtual System.Int64? MatchSetResultWorkspaceID 
				{
			get 
			{
				return this._MatchSetResulWorkspaceID;
			}
			set 
			{
				this._MatchSetResulWorkspaceID = value;
		...
		[XmlElement(ElementName = "WorkspaceMatchData")]
				public virtual System.String WorkspaceMatchData 
				{
			get 
			{
				return this._WorkspaceMatchData;
			}
			set 
			{
				this._WorkspaceMatchData = value;

			}
		}			

		[XmlElement(ElementName = "WorkspacePartialMatchData")]
				public virtual System.String WorkspacePartialMatchData 
				{
			get 
			{
				return this._WorkspacePartialMatchData;
			}
			set 
			{
				this._WorkspacePartialMatchData = value;

			}
		}			

		[XmlElement(ElementName = "WorkspaceUnmatchData")]
				public virtual System.String WorkspaceUnmatchData 
				{
			get 
			{
				return this._WorkspaceUnmatchData;
			}
			set 
			{
				this._WorkspaceUnmatchData = value;
