...
public partial class ScrollableCheckboxListWithSelectAll : UserControlBase
{
    ...
    private string DefaultCheckBoxListWidth = "200px";
    private string _checkBoxListWidth;
    #endregion
    ...
    public bool IsEnabled
    {
        set
        {
            if (value)
            {
                this.pnlScrollableCheckboxListWithSelectAll.Enabled = true;
                      
            }
            else
            {
                this.pnlScrollableCheckboxListWithSelectAll.Enabled = false;
    ...
    public int LableID
    {
        set
        {
            this.lblParamName.LabelID = value;
        }
    }
    public string CheckBoxListWidth
    {
        set
        {
            this._checkBoxListWidth = value;
            this.checkboxlistMaindiv.Style[HtmlTextWriterStyle.Width] = this._checkBoxListWidth;
            //this.divSelectAll.Style[HtmlTextWriterStyle.Width] = this._checkBoxListWidth;
            //this.divCheckBoxList.Style[HtmlTextWriterStyle.Width] = this._checkBoxListWidth;
        }
    }
    ...
    public bool Enabled
    {
        set
        {
            this.cblOptions.Enabled = value;
            this.chkSelectAll.Enabled = value;
            //this.checkboxlistMaindiv.Attributes.Add("disabled", "disabled");
        }
    }
    #endregion
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (String.IsNullOrEmpty(this._checkBoxListWidth))
        {
            this.checkboxlistMaindiv.Style[HtmlTextWriterStyle.Width] = this.DefaultCheckBoxListWidth;
        }
        this.rfv.Attributes.Add("controltocheck", this.cblOptions.ClientID);
    }
    protected void Page_PreRender(object sender, EventArgs e)
    {
        if (this.chkSelectAll.Enabled)
        {
    ...
    {
        this.cblOptions.SelectedIndex = -1;
        this.chkSelectAll.Checked = false;
    }
    #endregion
}
