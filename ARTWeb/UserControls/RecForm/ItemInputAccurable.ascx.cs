...
namespace SkyStem.ART.Web.UserControls
{
    ...
    public partial class UserControls_ItemInputAccurable : UserControlRecItemBase
    {
        ...
        //private GLDataRecItemInfo oGLRecItemInputInfo;
        #endregion
        #region "Page Events"
        ...
        public override void LoadData()
        {
            if (IsRefreshData && IsExpanded)
            {
                try
                {
                    ...
                    btnClose.OnClientClick = PopupHelper.GetJavascriptParameterList(null, "OpenRadWindow", "BulkCloseAccruable.aspx", QueryStringConstants.INSERT, false, this.AccountID, this.GLDataID, this.RecCategoryTypeID, this.NetAccountID, this.IsSRA, RecCategoryID, hdIsRefreshData.ClientID);
        ...
        private void EnableDisableControlsForNonPreparersAndClosedPeriods()
        {
            ...
            if (Helper.GetFormMode(WebEnums.ARTPages.ItemInputAccruable, this.GLDataHdrInfo) == WebEnums.FormMode.Edit)
            {
                btnAdd.Visible = true;
        ...
        private void CalculateAndDisplaySum()
        {
            ...
            //lblBaseCurrency.Text = Helper.GetLabelIDValue(1382) + " " + Helper.GetDisplayRecCategoryTypeID(this._RecCategoryType.Value) + " " + Helper.GetLabelIDValue(1769) + ":" + " " + this.CurrentBCCY + " " + Helper.GetDisplayDecimalValue(baseCurrencyTotal);
