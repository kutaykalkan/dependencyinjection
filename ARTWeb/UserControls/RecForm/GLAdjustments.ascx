                                    ...
                                    <td>
                                        <asp:Panel ID="pnlClosedItems" runat="server" Width="100%">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <UserControls:GLDataRecItemGrid ID="ucCloseGLDataRecItemGrid" AllowExportToExcel="true"
                                                            AllowExportToPDF="true" AllowCustomFilter="true" AllowCustomPaging="true" AllowSelectionPersist="true"
                                                            AllowDisplayCurrencyPnl="false" ShowSelectCheckBoxColum="true" ShowCloseDateColum="true"
                                                            runat="server">
                                                            <ColumnCollection>
                                                                <telerikWebControls:ExGridTemplateColumn LabelID="2087" ItemStyle-HorizontalAlign="Left"
                                                                    UniqueName="ExportFileIcon">
