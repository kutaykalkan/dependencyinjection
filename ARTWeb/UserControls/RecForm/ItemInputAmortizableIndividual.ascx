...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ItemInputAmortizableIndividual.ascx.cs"
    Inherits="SkyStem.ART.Web.UserControls.UserControls_ItemInputAmortizableIndividual" %>
                                        ...
                                        <tr>
                                            <td>
                                                <telerikWebControls:ExRadGrid ID="rgGLAdjustments" runat="server" Width="100%" ShowHeader="true"
                                                    ...
                                                    OnItemCreated="rgGLAdjustmentst_ItemCreated" AllowPrint="true" AllowPrintAll="true"
                                                    AllowSorting="true" ClientSettings-Selecting-AllowRowSelect="true" AllowMultiRowSelection="true"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <telerikWebControls:ExRadGrid ID="rgGLAdjustmentCloseditems" runat="server" Width="100%"
                                                                    ...
                                                                    OnItemCommand="rgGLAdjustmentCloseditems_ItemCommand" AllowExportToExcel="true" AllowExportToPDF="true"
                                                                    OnItemCreated="rgGLAdjustmentCloseditems_ItemCreated" AllowPrint="true" AllowPrintAll="true"
