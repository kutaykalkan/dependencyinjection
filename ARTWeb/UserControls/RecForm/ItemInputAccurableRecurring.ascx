                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <table id="tblMainContent" width="100%" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <telerikWebControls:ExRadGrid ID="rgAccurableRecurring" runat="server" ShowHeader="true"
                                            AllowInster="false" InsertLabelID="1413" InsertImageUrl="~/App_Themes/SkyStemBlueBrown/Images/Add_new_rule.gif"
                                            OnItemCommand="rgAccurableRecurring_ItemCommand" OnItemDataBound="rgAccurableRecurring_ItemDataBound"
                                            OnItemCreated="rgAccurableRecurring_ItemCreated" OnNeedDataSource="rgAccurableRecurring_NeedDataSource"
                                            OnDeleteCommand="rgAccurableRecurring_DeleteCommand" ClientSettings-Selecting-AllowRowSelect="true"
                                                ...
                                                <tr>
                                                    <td>
                                                        <telerikWebControls:ExRadGrid ID="rgGLAdjustmentCloseditems" runat="server" ShowHeader="true"
                                                            ...
                                                            AllowExportToPDF="true" AllowExportToExcel="true" AllowSorting="true" SkinID="SkyStemBlueBrownWithoutBorder"
                                                            ShowFooter="true">
