...
public partial class CheckBoxListWithSelectAll : UserControlBase 
{
            ...
            foreach (ListItem Litem in this.cblOptions.Items)
            {
                if (Litem.Selected)
                {
                    if (oSBCriteria.ToString().Equals(String.Empty))
                        ...
                        oSBCriteria.Append(AccountFilterHelper.AccountFilterValueSeparator + Litem.Value);
                }
            }
            return oSBCriteria.ToString();
        }
    }
    public bool HasValue
    {
        get
        {
            ...
            return !criteria.Equals(string.Empty);
        }
    }
    public string GetSelectedDisplayText
    {
        get
        {
            ...
            foreach (ListItem Litem in this.cblOptions.Items)
            {
                ...
                {
                    if (oSBCriteria.ToString().Equals(String.Empty))
                        oSBCriteria.Append(Litem.Text );
                    else
                        oSBCriteria.Append(AccountFilterHelper.AccountFilterValueSeparator + Litem.Text);
                }
            }
            return oSBCriteria.ToString();
        }
    ...
    //                oSBCriteria.Append(Litem.Value);
    //            else
    //                oSBCriteria.Append(WebConstants.RPTCRITERIAKEYVALUESEPERATOR + Litem.Value);
    //        }
    //    }
