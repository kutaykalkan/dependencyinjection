...
<%@ Register TagPrefix="UserControls" TagName="SubledgerVersion" Src="~/UserControls/MultiVersionSubledger/SubledgerVersion.ascx" %>
                                                ...
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr class="RecFormHeaderRow first">
                                                        <td class="RecFormFirstCol">
                                                            ...
                                                            <webControls:ExImageButton ID="imgShowNetAccountComposition" SkinID="ShowNetAccountComposition" runat="server" />
                                        ...
                                        <tr>
                                            <td>
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr>
                                                        <td colspan="5" class="htmlGridTitleDiv">
                                                            <webControls:ExLabel ID="lblSubledgerBalanceHeading" runat="server" LabelID="1084"
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            <webControls:ExLabel ID="lblSubledgerBalance" runat="server" LabelID="1085" SkinID="Black11Arial"></webControls:ExLabel>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                                 <webControls:ExImageButton ID="imgFileDownload" runat="server" ImageAlign="Left" LabelID="2028"
                                                                     SkinID="FileDownloadIcon" />
                                                            &nbsp;&nbsp;
                                                             <UserControls:SubledgerVersion ID="ucSubledgerVersion" runat="server" />
                                                        </td>
                                                        <td class="BCCYCol">
                                                            <webControls:ExLabel ID="lblSupportingDetailSubledgerBC" runat="server" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="RCCYCol">
                                                            <webControls:ExLabel ID="lblSupportingDetailSubledgerRC" runat="server" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                    </tr>
                                                    <%--Supporting Details Other Row--%>
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol" align="left">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportSupportingDetailOther" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td align="left">
                                                            <webControls:ExImageButton runat="server" ID="imgSupportingDetailsOther" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlGLAdjustment" SkinID="ViewItemGridHyperLink" />--%>
                                                        </td>
                                                        <td>
                                                            <webControls:ExLabel runat="server" ID="lblSupportingDetailOther" LabelID="1694" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="BCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblSupportingDetailOtherBC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="RCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblSupportingDetailOtherRC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                    </tr>
                                                    <%-- User control to show GLAdjustment in collapsable panel--%>
                                                    <tr>
                                            ...
                                            <td>
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            <webControls:ExLabel ID="lblSystemScore" LabelID="2442" FormatString="{0} : " runat="server" SkinID="Black11Arial" />
                                                            <webControls:ExLabel ID="lblSystemScoreValue" runat="server" SkinID="Black11Arial" />
                                                        </td>
                                                        <td>
                                                            <webControls:ExLabel ID="lblUserScore" LabelID="2443" FormatString="{0} : " runat="server" SkinID="Black11Arial" />
