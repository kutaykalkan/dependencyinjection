...
public partial class Pages_CertificationPrint_CertificationExceptionPrint : PopupPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        List<GLDataHdrInfo> oGLDataHdrInfoCollection = (List<GLDataHdrInfo>)Session[SessionConstants.CERTIFICATION_EXCEPTION_DATA]; ;
