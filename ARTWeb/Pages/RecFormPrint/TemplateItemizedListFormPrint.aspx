<%@ Page Language="C#" MasterPageFile="~/MasterPages/RecFormPrint.master" AutoEventWireup="true" Inherits="Pages_TemplateItemizedListFormPrint"
    Title="Untitled Page" Theme="SkyStemBlueBrown" ValidateRequest="false" Codebehind="TemplateItemizedListFormPrint.aspx.cs" %>
        ...
        <tr>
            <td>
                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                    ...
                    <tr>
                        <td colspan="4">
                            <UserControls:GLAdjustments ID="uctlGLAdjustment"  DisableExportInPrint="true" IsPrintMode="true" runat="server"
                                Visible="false" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <UserControls:GLAdjustments ID="uctlTimingDifference"  DisableExportInPrint="true" IsPrintMode="true" runat="server"
                                Visible="false" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="4">
                            <UserControls:GLAdjustments ID="uctlSupportingDetail"  DisableExportInPrint="true" IsPrintMode="true" runat="server"
                                Visible="false" />
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td>
                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                    ...
                    <tr>
                        <td colspan="4">
                            <UserControls:ItemInputWriteOff ID="uctlRecWriteOff"  DisableExportInPrint="true" IsPrintMode="true" runat="server"
                                Visible="false" />
                        </td>
                    </tr>
                    <tr class="GLAdjustmentRow">
