<%@ Page Language="C#" MasterPageFile="~/MasterPages/RecFormPrint.master" AutoEventWireup="true" Inherits="Pages_TemplateSubledgerFormPrint"
    Title="Untitled Page" Theme="SkyStemBlueBrown" ValidateRequest="false" Codebehind="TemplateSubledgerFormPrint.aspx.cs" %>
        ...
        <tr>
            <td>
                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                    ...
                    <tr>
                        <td colspan="4" class="htmlGridTitleDiv">
                            <webControls:ExLabel ID="lblTimmingDifference" runat="server" LabelID="1081" SkinID="Black11Arial"></webControls:ExLabel></td>
                    </tr>
                    <tr class="GLAdjustmentRow">
                        <td>
                            &nbsp;
                    ...
                    <tr class="GLAdjustmentRow">
                        ...
                        <td>
                            <webControls:ExLabel ID="ExLabel5" runat="server" LabelID="1085" SkinID="Black11Arial"></webControls:ExLabel>
                        </td>
                        <td class="BCCYCol">
                    ...
                    <tr class="GLAdjustmentRow">
                        ...
                        <td>
                            <webControls:ExLabel runat="server" ID="lblSupportingDetailOther" LabelID="1694"
                                SkinID="Black11Arial"></webControls:ExLabel>
                        </td>
                        <td class="BCCYCol">
                    ...
                    <tr>
                        <td colspan="4">
                            <UserControls:GLAdjustments ID="uctlSupportingDetailOther" DisableExportInPrint="true"
                                IsPrintMode="true" runat="server" Visible="false" />
                        </td>
                    </tr>
                    <tr class="GLAdjustmentRowTotalSupportingDetail">
                        ...
                        <td align="left">
                            <webControls:ExLabel ID="lblSubledgerBalance" runat="server" LabelID="1656" SkinID="Black11Arial"></webControls:ExLabel>
                        </td>
                        <td class="BCCYCol">
                            <webControls:ExLabel ID="lblTotalSupportingDetailBC" runat="server" SkinID="Black11Arial"></webControls:ExLabel>
                        </td>
                        <td class="RCCYCol">
                            <webControls:ExLabel ID="lblTotalSupportingDetailRC" runat="server" SkinID="Black11Arial"></webControls:ExLabel>
                        </td>
                    </tr>
                </table>
            </td>
