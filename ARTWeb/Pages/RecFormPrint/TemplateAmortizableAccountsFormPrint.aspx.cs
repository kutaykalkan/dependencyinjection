...
public partial class Pages_RecFormPrint_TemplateAmortizableAccountsFormPrint : PageBaseRecForm
{
    ...
    string lblReviewedRecStatusCount =  string.Empty;
    ...
    private void LoadSupportingDetail(UserControls_ItemInputAmortizableTemplate ucSupportingDetail, WebEnums.RecCategory? enumRecCategory, WebEnums.RecCategoryType enumRecCategoryType)
    {
