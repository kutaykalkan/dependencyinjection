<%@ Page Language="C#" MasterPageFile="~/MasterPages/PopUpMasterPage.master" AutoEventWireup="true" Inherits="Pages_EditRecControlCheckListComment" Theme="SkyStemBlueBrown" Codebehind="EditRecControlCheckListComment.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <asp:Panel ID="pnlEnteredBy" runat="server">
            <tr>
                <td></td>
                <%--Entered By--%>
                <td>
        ...
        <tr>
            ...
            <td valign="top">
                <webControls:ExLabel ID="lblCommentHeading" runat="server" FormatString="{0}:"
                    LabelID="2587" SkinID="Black11Arial"></webControls:ExLabel>
            </td>
            <td colspan="3">
