<%@ Page Language="C#" MasterPageFile="~/MasterPages/PopUpMasterPage.master" AutoEventWireup="true" Inherits="Pages_BulkCloseAmortizable"
    Theme="SkyStemBlueBrown" Codebehind="BulkCloseAmortizable.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--<input type="text" id="hdnMaxSelectedOpenDate" runat="server" style="display: none" />--%>
    <asp:HiddenField ID="hdnMaxSelectedOpenDate" runat="server" />

    <script language="javascript" type="text/javascript">

        var maxOpendateHdnControl = $get('<% =this.hdnMaxSelectedOpenDate.ClientID %>');
        function Selected(sender, args) {
            var cell;
            var openDate;
            var baseCurrencyValue = 0;
            var reportingCurrencyValue = 0;
            var maxSelectedOpenDate = maxOpendateHdnControl.value;
            ...
            maxOpendateHdnControl.value = maxSelectedOpenDate;
        }
        ...
        function CompareOpenAndCloseDates(sender, args) {
            ...
            openDate = calOpenDate.value.trim();
