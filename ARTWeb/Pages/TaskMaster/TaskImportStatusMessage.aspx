            ...
            <td align="center">
                <asp:Panel ID="pnlErrorUpload" runat="server">
                    <table width="60%" class="DataImportStatusMessage" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <webControls:ExLabel ID="ExLabel2" runat="server" SkinID="Black11Arial" LabelID="2499"
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="2" align="right">
                                            ...
                                            <webControls:ExButton ID="btnReject" runat="server" SkinID="ExButton100" LabelID="1239"
