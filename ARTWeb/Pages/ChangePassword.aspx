                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ChangePasswordBg">
                            ...
                            <tr>
                                <td colspan="3" align="left" style="text-indent: 10px">
                                    <webControls:ExLabel ID="lblChangePassword" runat="server" LabelID="1078" SkinID="BlueBold11ArialUnderline"></webControls:ExLabel>
                                </td>
                                <td>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" align="left">
                                    <asp:TextBox ID="txtOldPassword" AutoCompleteType="Disabled" autocomplete="off" runat="server" SkinID="TextBox200" TextMode="Password" />
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNewPassword" AutoCompleteType="Disabled" autocomplete="off" SkinID="TextBox200" runat="server" TextMode="Password" /><webControls:ExRequiredFieldValidator
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtConfirmPassword" AutoCompleteType="Disabled" autocomplete="off" runat="server" SkinID="TextBox200" TextMode="Password" /><webControls:ExRequiredFieldValidator
