<%@ Page Language="C#" MasterPageFile="~/MasterPages/RecProcessMasterPage.master"
    AutoEventWireup="true" Inherits="Pages_TemplateAmortizableAccountsForm"
    Title="Untitled Page" Theme="SkyStemBlueBrown" ValidateRequest="false" Codebehind="TemplateAmortizableAccountsForm.aspx.cs" %>
                                                ...
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            ...
                                                            <webControls:ExImageButton runat="server" ID="imgGLAdjustment" SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            ...
                                                            <webControls:ExImageButton runat="server" ID="imgTimingDifference" SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportIndividualAmortizableDetail"
                                                                SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <webControls:ExImageButton runat="server" ID="imgViewIndividualAmortizableDetail"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                            <webControls:ExLabel runat="server" ID="lblIndividualAmortizableDetail" LabelID="2251"
                                                                SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="BCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblIndividualAmortizableDetailBC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="RCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblIndividualAmortizableDetailRC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                    </tr>
                                                    <%-- User control to show ItemInputAmortizable in collapsable panel--%>
                                                    <tr>
                                                        <td colspan="5">
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            ...
                                                            <webControls:ExImageButton runat="server" ID="imgSupportingDetail" SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                            <webControls:ExLabel runat="server" ID="ExLabel8" LabelID="2252" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="BCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblRecurringAmortizableScheduleBC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                        <td class="RCCYCol">
                                                            <webControls:ExLabel runat="server" ID="lblRecurringAmortizableScheduleRC" SkinID="Black11Arial"></webControls:ExLabel>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5">
