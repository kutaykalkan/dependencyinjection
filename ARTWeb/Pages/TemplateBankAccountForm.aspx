    ...
    <asp:Panel ID="pnlRecForm" runat="server">
                                            ...
                                            <td>
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportBankFees" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlBankFee" SkinID="ViewItemGridHyperLink" />--%>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportNSFFees" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlNSFFees" SkinID="ViewItemGridHyperLink" />--%>
                                                            <webControls:ExImageButton runat="server" ID="imgViewNSFFee" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportOtherInGLAdjustments" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlOtherInGLAdjustments" SkinID="ViewItemGridHyperLink" />--%>
                                                            <webControls:ExImageButton runat="server" ID="imgViewOtherInGLAdjustments" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportDepositInTransit" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlDepositInTransit" SkinID="ViewItemGridHyperLink" />--%>
                                                            <webControls:ExImageButton runat="server" ID="imgViewDepositInTransit" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportOutstandingChecks" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlOutstandingChecks" SkinID="ViewItemGridHyperLink" />--%>
                                                            <webControls:ExImageButton runat="server" ID="imgViewOutstandingChecks" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        <td class="RecFormFirstCol">
                                                            <webControls:ExHyperLink runat="server" ID="hlImportOtherInTimingDifference" SkinID="ImportItemHyperLink" />
                                                        </td>
                                                        <td>
                                                            <%--<webControls:ExHyperLink runat="server" ID="hlOtherInTimingDifference" SkinID="ViewItemGridHyperLink" />--%>
                                                            <webControls:ExImageButton runat="server" ID="imgViewOtherInTimingDifference" EnableViewState="true"
                                                                SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                ...
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="tanBorder">
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            ...
                                                            <webControls:ExImageButton runat="server" ID="imgViewRecWriteOff" SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="GLAdjustmentRow">
                                                        ...
                                                        <td>
                                                            ...
                                                            <webControls:ExImageButton runat="server" ID="imgViewUnexplainedVariance" SkinID="ViewItemGridCollapsableImageButton" />
                                                        </td>
                                                        <td>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function OnClientAddButtonClickedGeneralTask(sender, args) {
                ...
                var funcName = button.get_attributes("<%=SkyStem.ART.Web.Data.TaskViewerConstants.TOOLBAR_COMMAND_ADD_ATTRIBUTE_NAME_GENERAL_TASK %>").getAttribute("<%=SkyStem.ART.Web.Data.TaskViewerConstants.TOOLBAR_COMMAND_ADD_ATTRIBUTE_NAME_GENERAL_TASK %>");
                eval(funcName);
            }
