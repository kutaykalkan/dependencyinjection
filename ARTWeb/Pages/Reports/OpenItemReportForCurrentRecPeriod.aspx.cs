...
public partial class Pages_Reports_OpenItemReportForCurrentRecPeriod : PageBaseReport
{
    short? _reportID = 0;
    ...
    private List<OpenItemsReportInfo> GetGridData()
    {
        ...
        try
        {
            ...
            if (oOpenItemsReportInfoCollection == null || oOpenItemsReportInfoCollection.Count == 0)
            {
                ...
                oOpenItemsReportInfoCollection = oReportClient.GetReportOpenItemsReportForCurrentRecPeriod(oReportSearchCriteria, dtEntity, dtUser, dtRole, Helper.GetAppUserInfo());
